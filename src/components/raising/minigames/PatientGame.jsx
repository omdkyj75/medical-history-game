...
const CASES = [
  { symptoms: "발열, 오한, 두통, 몸살", diagnosis: "태양병(太陽病) - 풍한표증", correct: "계지탕(桂枝湯)", wrong: ["사물탕(四物湯)", "보중익기탕(補中益氣湯)", "대승기탕(大承氣湯)"] },
  { symptoms: "고열, 심한 갈증, 땀이 많음", diagnosis: "양명병(陽明病) - 기분열성", correct: "백호탕(白虎湯)", wrong: ["마황탕(麻黃湯)", "소시호탕(小柴胡湯)", "이중환(理中丸)"] },
  { symptoms: "식욕부진, 피로감, 기운 없음", diagnosis: "비기허(脾氣虛)", correct: "보중익기탕(補中益氣湯)", wrong: ["백호탕(白虎湯)", "대시호탕(大柴胡湯)", "마자인환(麻子仁丸)"] },
  { symptoms: "가슴 답답, 옆구리 통증, 입 쓴맛", diagnosis: "소양병(少陽病) - 반표반리", correct: "소시호탕(小柴胡湯)", wrong: ["계지탕(桂枝湯)", "백호탕(白虎湯)", "사역탕(四逆湯)"] },
  { symptoms: "수족냉, 설사, 맥미약", diagnosis: "소음병(少陰病) - 양허한증", correct: "사역탕(四逆湯)", wrong: ["백호탕(白虎湯)", "마황탕(麻黃湯)", "보중익기탕(補中益氣湯)"] },
  { symptoms: "어지러움, 안면창백, 심계항진", diagnosis: "혈허(血虛)", correct: "사물탕(四物湯)", wrong: ["소시호탕(小柴胡湯)", "대승기탕(大承氣湯)", "계지탕(桂枝湯)"] },
  { symptoms: "기침, 가래, 흉민", diagnosis: "담음(痰飮)", correct: "이진탕(二陳湯)", wrong: ["계지탕(桂枝湯)", "사역탕(四逆湯)", "백호탕(白虎湯)"] },
  { symptoms: "변비, 복부팽만, 설태황조", diagnosis: "양명부실(陽明腑實)", correct: "대승기탕(大承氣湯)", wrong: ["소시호탕(小柴胡湯)", "사물탕(四物湯)", "이중환(理中丸)"] },
  { symptoms: "두통, 코막힘, 맑은 콧물", diagnosis: "풍한감모(風寒感冒)", correct: "마황탕(麻黃湯)", wrong: ["백호탕(白虎湯)", "보중익기탕(補中益氣湯)", "사물탕(四物湯)"] },
  { symptoms: "불면, 심계, 다몽", diagnosis: "심비양허(心脾兩虛)", correct: "귀비탕(歸脾湯)", wrong: ["대승기탕(大承氣湯)", "마황탕(麻黃湯)", "소시호탕(小柴胡湯)"] },
  { symptoms: "요통, 이명, 야간빈뇨", diagnosis: "신양허(腎陽虛)", correct: "팔미환(八味丸)", wrong: ["사물탕(四物湯)", "백호탕(白虎湯)", "이진탕(二陳湯)"] },
  { symptoms: "구갈, 소변빈삭, 체중감소", diagnosis: "음허내열(陰虛內熱)", correct: "육미지황환(六味地黃丸)", wrong: ["팔미환(八味丸)", "마황탕(麻黃湯)", "대승기탕(大承氣湯)"] }
];
